      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold">LocationTracker</span>
            </div>
            <p className="text-gray-300 mb-4">
              Providing reliable location tracking services for individuals and businesses.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span>+8801787817803</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-brand-blue mr-2" />
                <span>mahmudurrahmanrifat96@gmail.com</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/dashboard" className="text-gray-300 hover:text-brand-blue transition-colors">
                  Services
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <p className="text-center text-gray-400">
            &copy; {new Date().getFullYear()} LocationTracker. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
